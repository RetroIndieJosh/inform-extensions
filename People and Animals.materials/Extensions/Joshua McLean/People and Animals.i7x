People and Animals by Joshua McLean begins here.
...
Understand "person" as a not introduced visible person. Understand "man" as a visible man. Understand "woman" as a visible woman.
...
Section 4 - Worn Objects Have Zero Bulk (for use with Bulk Limiter by Eric Eve)
...
Example: * Man Woman Person - Refer to people with generic words
	...
	*: "Man Woman Person"
	...
	Include People and Animals by Joshua McLean.

	The check for missing descriptions when play begins rule is not listed in any rulebook.
	
	The Party Room is a room.

	A man called a balding man is here. Understand "John" as the balding man. The real name is "John". The description is "A balding man. You think his name started with J, but you're not sure."
	A woman called a dark-haired woman is here. Understand "Susan" as the dark-haired woman. The real name is "Susan". The description is "A dark-haired woman. You don't know much else about her."

	Test me with "x man / x woman / x person".
